...
from src.model.repositories.interface.eventos_links_repository import EventosLinkRepositoryInterface
...
class EventsLinkCreator:
    ...
    def __format_response(self, new_link: str, event_id: int, subscriber_id: int) -> HttpsResponse:
